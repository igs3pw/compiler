 ...
 */
%type <declList>  DeclList FieldList ProtoList Fields
%type <decl>      Decl
%type <type>      Type 
...
%type <stmt>      StmtBlock Stmt IfStmt WhileStmt ForStmt BreakStmt RetStmt PrintStmt
...
IfaceDecl :    T_Interface T_Identifier '{' ProtoList '}'
